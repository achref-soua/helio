...
- 🗺️ **Platform integrations** — generated SDKs, outbound webhooks, docs site
...
- [Local-dev runbook](docs/runbooks/local-dev.md) · [SSO & SCIM setup](docs/sso.md) · [API spec (OpenAPI 3.1)](apps/api/openapi.json)
